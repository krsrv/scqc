...
w = jnp.array(
    [
        ...
        # # 5 points, 1.7e-4 eigenvalue loss for T, theta=0
        [-6.1251, -2.5950, -4.7881, -3.6208, 0.0073, -1.2397, -5.7810, 0.9669],
        [0.6287, -1.5808, -3.2439, -1.0716, -4.3734, -5.0442, 0.9572, 2.7256],
        [-3.1976, -7.0036, 1.1270, -2.8684, 3.6362, 0.4805, -2.6666, -0.5998],
        [-7.8565, -3.7444, 2.8322, -7.3322, 2.0151, -4.2279, 4.0013, 6.0033],
        [-2.6495, -3.2433, 5.0245, -1.4874, 4.6881, -2.2012, 0.6348, 0.8263],
        # fmt: on
        # Constrained
